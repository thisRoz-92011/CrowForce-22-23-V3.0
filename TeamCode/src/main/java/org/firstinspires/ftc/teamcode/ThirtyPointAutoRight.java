    ...
    public void runOpMode() {
        ...
        if (tagOfInterest != null) {
            ...
            if (tagPosition == 1) {
                ...
                moveSimpleTargetPosition(.25, 2700, 2, 100);
                moveSimpleTargetPosition(.25, 2250, 1, 100);
                moveSimpleTargetPosition(.25, 1000, 2, 100);;
                moveSimpleTargetPosition(.25, 300, 1, 100);
                setSlider(1, 3, 500);
                grippers(1, 500);
                moveSimpleTargetPosition(.25, 300, 3, 100);
                setSlider(0.5, 0, 500);


                moveSimpleTargetPosition(.25, 7000, 4, 500);
            ...
            if (tagPosition == 2) {
                ...
                moveSimpleTargetPosition(.25, 4000, 4, 500);
            }
            ...
            if (tagPosition == 3) {
                ...
                moveSimpleTargetPosition(.25, 1500, 4, 500);
